...
#+BEGIN_SRC emacs-lisp
    ...
    (defun zxmth/load-theme (&optional default-theme)
      (unless default-theme (setq default-theme 'monokai))
    ...
    ;;   ;; unset the checkbox styling - the default looks stupid
    ;;   (set-face-attribute 'org-checkbox nil :box 'unspecified :background 'unspecified))
