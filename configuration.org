...
#+BEGIN_SRC emacs-lisp
  ...
  (setq org-index-file (org-agenda-file-path "index.org"))
  (setq org-inbox-file (org-agenda-file-path "inbox.org"))
  (setq org-habit-file (org-agenda-file-path "habits.org"))
  (setq org-archive-location
        (concat (org-agenda-file-path "archive.org") "::* From %s"))

  (setq org-agenda-files
        (list org-index-file org-inbox-file org-habit-file org-notes-directory))
#+END_SRC
