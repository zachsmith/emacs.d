...
[[https://github.com/dimitri/switch-window][switch-window]] is great for jumping around windows
...
#+BEGIN_SRC emacs-lisp
  (use-package switch-window
    ...
    (global-set-key (kbd "C-c C-SPC s") 'switch-window)
    (global-set-key (kbd "C-c C-SPC m") 'switch-window-then-maximize)
    (global-set-key (kbd "C-c C-SPC v") 'zxmth/split-window-below-and-switch)
    (global-set-key (kbd "C-c C-SPC V") 'switch-window-then-split-below)
    (global-set-key (kbd "C-c C-SPC h") 'zxmth/split-window-right-and-switch)
    (global-set-key (kbd "C-c C-SPC H") 'switch-window-then-split-right)
    (global-set-key (kbd "C-c C-SPC k") 'switch-window-then-delete)
    (global-set-key (kbd "C-c C-SPC f") 'switch-window-then-find-file)
    (global-set-key (kbd "C-c C-SPC b") 'switch-window-then-display-buffer)
    (global-set-key (kbd "C-c C-SPC K") 'switch-window-then-kill-buffer))
#+END_SRC
        ...
        '(("d" "Daily Agenda"
           ((tags "PRIORITY=\"A\""
            ...
            (tags "TODO=\"QUESTION\"|TODO=\"LEARNING\"|TODO=\"IDEA\"|TODO=\"PLANNING\""
                  ((org-agenda-skip-function '(zxmth/org-skip-subtree-if-priority ?A))
...
#+BEGIN_SRC emacs-lisp
  ...
  (use-package org-roam
    ...
    :config
    (defcustom zxmth-org-roam-directory
      (file-truename (concat (file-name-as-directory org-directory) "zk"))
      "Set to org-roam-directory for the machine I'm on")
    (setq org-roam-directory zxmth-org-roam-directory)
    (setq org-roam-db-location
          (concat (file-name-as-directory org-roam-directory) ".roam/org-roam.db"))
    (setq org-roam-index-file
          (concat (file-name-as-directory org-roam-directory) "org-roam-index.org"))
    ...
    (add-hook 'org-roam-find-file-hook #'org-hide-properties)
    ...
    (("C-c n c" . org-roam-capture)
     ...
     ("C-c n ?" . org-toggle-properties)))
#+END_SRC

org-roam v2 introduces a requirement for :PROPERTIES: which aren't great to look
at. This allows those properties to be toggled on and off. [[https://github.com/org-roam/org-roam/wiki/Hitchhiker's-Rough-Guide-to-Org-roam-V2#hiding-the-properties-drawer][(copied from here)]]
