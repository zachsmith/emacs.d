...
I like to see line and column numbers by default
...
#+BEGIN_SRC emacs-lisp
  (use-package switch-window
    ...
    (global-set-key (kbd "C-c SPC s") 'switch-window)
    (global-set-key (kbd "C-c SPC SPC") 'switch-window)
    (global-set-key (kbd "C-c SPC M") 'switch-window-then-maximize)
    (global-set-key (kbd "C-c SPC V") 'switch-window-then-split-below)
    (global-set-key (kbd "C-c SPC H") 'switch-window-then-split-right)
    (global-set-key (kbd "C-c SPC k") 'switch-window-then-delete)
    (global-set-key (kbd "C-c SPC f") 'switch-window-then-find-file)
    (global-set-key (kbd "C-c SPC b") 'switch-window-then-display-buffer)
    (global-set-key (kbd "C-c SPC K") 'switch-window-then-kill-buffer))
#+END_SRC

Bind additional keys for window navigation

#+BEGIN_SRC emacs-lisp
  ;; delete the focused window
  (global-set-key (kbd "C-c 0") 'delete-window)
  (global-set-key (kbd "C-c SPC 0") 'delete-window)
  (global-set-key (kbd "C-c SPC d") 'delete-window) ;; preferred

  ;; maximixe the focused window
  (global-set-key (kbd "C-c 1") 'delete-other-windows)
  (global-set-key (kbd "C-c SPC 1") 'delete-other-windows)
  (global-set-key (kbd "C-c SPC m") 'delete-other-windows) ;; preferred

  ;; split window and then focus on the new split
  (global-set-key (kbd "C-c SPC v") 'zxmth/split-window-below-and-switch)
  (global-set-key (kbd "C-x 2") 'zxmth/split-window-below-and-switch) ;; deprecated
  (global-set-key (kbd "C-c SPC h") 'zxmth/split-window-right-and-switch)
#+END_SRC
...
** Some basic [[https://orgmode.org][Org-mode]] configurations
 ...
 #+BEGIN_SRC emacs-lisp
   ...
   ;; disable Table of Contents in exported docs by default
...
** Use deft for searching org and markdown files
...
#+BEGIN_SRC emacs-lisp
  (use-package deft
    ...
    (setq deft-directory org-notes-directory)
...
Default syntax checking for a variety of file types
