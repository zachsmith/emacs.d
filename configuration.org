...
Install icons for use in dired and ivy
...
** Use monokai & spacemacs-light themes
...
#+BEGIN_SRC emacs-lisp
  ...
  (defun zxmth/post-load-dark-theme (theme-name)
    ...
    (custom-theme-set-faces
     theme-name
     '(dired-subtree-depth-1-face ((t (:backgroup "#252e30"))))
     '(dired-subtree-depth-2-face ((t (:backgroup "#232a2b"))))
     '(dired-subtree-depth-3-face ((t (:backgroup "#212627"))))
     '(dired-subtree-depth-4-face ((t (:backgroup "#1e2223"))))
     '(dired-subtree-depth-5-face ((t (:backgroup "#1c1d1e"))))
     '(dired-subtree-depth-6-face ((t (:backgroup "#1a191a"))))))
