...
#+BEGIN_SRC emacs-lisp
  ...
  (defcustom zxmth-org-agenda-files (-non-nil (list org-index-file org-inbox-file org-habit-file org-notes-directory org-remote-notes-directory))
    "List of files to include in constructing org agenda")

  (setq org-agenda-files zxmth-org-agenda-files)

  (defcustom org-brain-file (concat (file-name-as-directory org-notes-directory) "brain.org")
